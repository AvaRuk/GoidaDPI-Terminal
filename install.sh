...
set_permissions() {
  ...
  if [ ! -d /system/xbin ]; then
    ...
    mv $MODPATH/system/xbin/gdpit $MODPATH/system/$bin
    mv $MODPATH/system/xbin/nfqws $MODPATH/system/$bin
    rm -rf $MODPATH/system/xbin/*
    rmdir $MODPATH/system/xbin
  fi
  mv $MODPATH/system/DPI $MODPATH/
  set_perm $MODPATH/system/$bin/gdpit 0 0 0777
  set_perm $MODPATH/system/$bin/nfqws 0 0 0777
